...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx0d7fe6cd47587545'),         // AppID
    'secret'  => env('WECHAT_SECRET', '726609b60b5d78639850bea44bf729b2'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'chichuang'),          // Token
    'aes_key' => env('WECHAT_AES_KEY', 'Ic9vsBl0YIujbPZNQVV2fdK10yvEt8CgXo5nnczuaT5'),                    // EncodingAESKey
